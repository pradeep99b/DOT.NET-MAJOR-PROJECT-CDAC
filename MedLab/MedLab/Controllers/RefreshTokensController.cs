...
namespace MedLab.Controllers
{
    ...
    public class RefreshTokensController : ControllerBase
    {
        ...
        public RefreshTokensController(MedLabContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<RefreshToken>> PostRefreshToken(RefreshToken refreshToken)
        {
            ...
            return CreatedAtAction("GetRefreshToken", new { id = refreshToken.TokenID }, refreshToken);
        }
        ...
        {
            return _context.RefreshToken.Any(e => e.TokenID == id);
        }
    }
}
